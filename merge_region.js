...
// Reads 4 tmp files, merges into idealista_raw.json, deletes tmp files
const fs = require('fs');
const slug = process.argv[2];
const name = process.argv[3];
const dir  = '/Users/elenaushakova/Downloads/House investing Spain/casadata project copy 7';
...
const raw = JSON.parse(fs.readFileSync(`${dir}/idealista_raw.json`,'utf8'));
raw.regions[slug] = {
  name,
...
fs.writeFileSync(`${dir}/idealista_raw.json`, JSON.stringify(raw, null, 2));
