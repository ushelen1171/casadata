...
const REGIONS = [
  { name:'Baleares',        price:4905, rent:18.70, itp:0.08,  growth10:113, color:'#c9a84c' },
  { name:'Madrid',          price:4234, rent:20.30, itp:0.06,  growth10:86,  color:'#4a90d9' },
  { name:'País Vasco',      price:3035, rent:14.90, itp:0.07,  growth10:56,  color:'#5cb88a' },
  { name:'Canarias',        price:2789, rent:12.90, itp:0.065, growth10:107, color:'#9b7fd4' },
  { name:'Cataluña',        price:2560, rent:20.02, itp:0.10,  growth10:55,  color:'#e07a5f' },
  { name:'Andalucía',       price:2468, rent:12.60, itp:0.07,  growth10:72,  color:'#f2cc8f' },
  { name:'Valencia',        price:2207, rent:14.90, itp:0.10,  growth10:70,  color:'#81b29a' },
  { name:'Cantabria',       price:1750, rent:9.50,  itp:0.10,  growth10:46,  color:'#a8c5da' },
  { name:'Navarra',         price:1800, rent:9.80,  itp:0.06,  growth10:44,  color:'#d4a5a5' },
  { name:'Galicia',         price:1650, rent:8.20,  itp:0.10,  growth10:43,  color:'#a8d8a8' },
  { name:'Aragón',          price:1600, rent:8.00,  itp:0.08,  growth10:45,  color:'#c9b7d8' },
  { name:'Asturias',        price:1480, rent:7.80,  itp:0.08,  growth10:35,  color:'#b8c9d8' },
  { name:'Murcia',          price:1250, rent:7.50,  itp:0.08,  growth10:47,  color:'#d8b894' },
  { name:'La Rioja',        price:1400, rent:7.20,  itp:0.07,  growth10:33,  color:'#c8d894' },
  { name:'Castilla y León', price:1300, rent:6.80,  itp:0.08,  growth10:30,  color:'#94b8c8' },
  { name:'Extremadura',     price:900,  rent:6.00,  itp:0.08,  growth10:15,  color:'#b8a894' },
  { name:'C.-La Mancha',    price:850,  rent:5.80,  itp:0.09,  growth10:21,  color:'#a8a8a8' },
];
